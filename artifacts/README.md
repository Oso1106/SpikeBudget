...
| `external_scratch_summaries` | Compact summary rows for dense low-LR scratch stability verification and long-horizon dense scratch verification extracted from the supplied evidence map. | Raw logs, raw JSONL files, generated checkpoints, and datasets. |
