...
| Public artifact coverage | Current repository | Only lightweight DCLM benchmark-protocol diagnostic and dense low-LR scratch artifacts are included. Other evidence lanes are summary-only or marked external-missing until small public evidence files are added. |
