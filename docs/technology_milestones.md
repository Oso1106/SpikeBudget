...
| Capacity and language-model scaling bridge | evidence | L4 and RTX 3090 experiments show large SNN-transformer training from scratch is feasible, but quality is hard. | This branch bridges systems roofline evidence to language-model quality experiments. | summary_only |
